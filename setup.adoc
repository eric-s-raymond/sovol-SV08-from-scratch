...
Find the enclosure installation video on YouTube, it is
more up to date than the manual. Link in References, below.
...
assembly manual - the newer version has a long horizontal shank
...
(assembly step 2 in the manual) were labeled 'Step 3' on their bag.
