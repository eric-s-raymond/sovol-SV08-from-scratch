...
steppers may repleatedly try to drive the gantry past its physical
...
printer even when the shield is stil on the motherboard electronics.
...
The chamber fan goes on the *outside* of ther rear panel, with the fan
cable threading through to thge inside.  Neither the enclosure manual
nor the Sovol installation videpoi is explicit about this, though
gerGo's video is.

Important: after building the enclosure, check that all the stepper
motor connectors are firmly seated. Mine got loosened, leating to
chatterbox failure.
